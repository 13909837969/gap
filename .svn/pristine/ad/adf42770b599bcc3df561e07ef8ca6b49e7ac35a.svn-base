...
<script type="text/javascript">
	$(function() {
		...
		//显示隐藏的区域选择
		$("#ViewWhsshqdlyQX_qyss").click(function(){
		...
		/*时间事件*/
		$("#ViewWhsshqdlyQX_kssj").unbind("click").bind("click",function(){
	//日历
...
$("#ViewWhsshqdlyQX_jssj").unbind("click").bind("click",function(){
	//日历
	$(".form_datetime").datetimepicker({
	       format: "yyyy-mm-dd",
	       language:  'zh-CN',
			...
			series : [
					{
						...
						data : [500,720,100,500,400,200,200,200,200,200],
						itemStyle : {
							normal : {
								color : '#0d9bff'
							}
					...
					},
					{
						name : '2017年',
						type : 'bar',
						data : [500,300,300,600,810,700,100,200,800,213],
						itemStyle : {
							normal : {
								color : '#f5ce0c'
							}
...
<!--表头搜索 总计  -->
		<div class="col-md-12"  style="padding-top:20px;">
			<div class="col-md-5" id="test1">
				<div class="col-md-3">
					<input type="text" class="form-control" id="ViewWhsshqdlyQX_qyss" placeholder="区域搜索">
				</div>
				<div class="col-md-3">
					<input type="text" class="form-control form_datetime" id="ViewWhsshqdlyQX_kssj"placeholder="开始时间">
				</div>
				<div class="col-md-3">
					<input type="text" class="form-control form_datetime" id="ViewWhsshqdlyQX_jssj"placeholder="结束时间">
				</div>
				<div class="col-md-3">
		...
		<div class="col-md-7">
			<div  class="col-md-3">
					<div class="col-md-12" id="text3">
						<p style="margin-top: 15px"><a href="#">呼和浩特市挽回损失或取得利益人员总数</a></p>
						<p >848万元</p>
					</div>
				</div>
				<div  class="col-md-3">
					<div class="col-md-12" id="text3">
						<p style="margin-top: 15px">呼和浩特市刑事法律援助挽回损失或取得利益</p>
						<p>2496万元</p>
					</div>
				</div>
				...
				<div  class="col-md-3">
					<div class="col-md-12" id="text3">
						<p style="margin-top: 15px">呼和浩特市民事法律援助挽回损失或取得利益</p>
						<p>241万元</p>
					</div>
				</div>
				...
				<div  class="col-md-3">
					<div class="col-md-12" id="text3">
						<p style="margin-top: 15px">呼和浩特市行政法律援助挽回损失或取得利益</p>
						<p>24961件</p>
					</div>
				</div>
			</div>		
		...
		<div class="col-md-12" >
			<div class="col-md-12" id="Whsshqdly-div1">
				<div style="background-color: #333;" class="form-Whsshqdly-1" >
					<div class="form-Whsshqdly" style="font-size: 20px">呼和浩特市挽回损失或取得利益总览</div>
		...
		<div class="col-md-12">
			<div class="col-md-5" id="Whsshqdly-div2">
				<div style="background-color: #333;" class="form-Whsshqdly-1" >
				<div class="form-Whsshqdly" style="font-size: 20px">呼和浩特市挽回损失或取得利益的环比率</div>
			...
			<div class="col-md-7" id="Whsshqdly-div2">
				<div style="background-color: #333;" class="form-Whsshqdly-1" >
					<div class="form-Whsshqdly" style="font-size: 20px">呼和浩特市挽回损失或取得利益的同比率</div>
