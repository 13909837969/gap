...
@Service("ShzyzxxbService")
public class ShzyzxxbService extends AbstractService{
	...
	public ResultList<BasicMap<String,Object>> find(BasicMap<String,Object> data,Paginate page){
		...
		String sql="SELECT id,rybm,xm,xb,csrq,sfzh,mz,zy,zzmm,byyx,xl,zgxw,ssjg,sjhm,lxdh,zz FROM JC_SFXZJGGZRYJBXX";
		SQLAdapter sqlAdapter = new SQLAdapter(sql);
		filter.eq("orgid", user.getOrgid());
		filter.eq("rybm",data.get("rybm"));
