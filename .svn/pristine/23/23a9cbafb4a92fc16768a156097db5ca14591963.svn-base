 ...
 *
 */
@Service("SfsYsqkxxcjbService")
public class SfsYsqkxxcjb extends AbstractService {
		...
		if(user!=null) {
			...
			list=dbClient.find(sqladpter, paginate, new RowDataListener() {
				...
				public void processData(BasicMap<String, Object> rowData) {
					...
					rowData.put("ysqssj", DateUtil.format(rowData.get("ysqssj"), "yyyy-MM-dd"));
				}
			});
		}
		return list;
	...
	public void deleteOne(BasicMap<String, Object> query) {
		dbClient.remove(SupConst.Collections.SFS_SFSXXGZXCSQYSQKXXB, new SqlDbFilter().eq("id", StringUtil.toEmptyString(query.get("id"))));
	}
