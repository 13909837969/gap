Eht.TableView=function(opt){
	...
	this.paginateBar = $('<div class="ltrhao-bar text-right ltrhao-pagebar">'+
			...
			'<li><a class="tableView_first">首页</a></li>'+
			'<li><a class="tableView_previous">上页</a></li>'+
			'<li><a class="tableView_next">下页</a></li>'+
			'<li><a class="tableView_last">末页</a></li>'+
			'<li><input class="tableView_page" text="text" style="width:40px;margin-right:4px;"/></li>'+
			'<li><input class="tableView_go" type="button" value="Go.."/></li>'+
			'<li><div>第<span class="pageIndex"></span>页/共<span class="totalPage"></span>页 '+
			'每页 <select class="pageIndexOpt"><option>60</option></select>条 （共 <span class="total"></span> 条）</div></li>'+
			'</ul>'+
			'</div>');
