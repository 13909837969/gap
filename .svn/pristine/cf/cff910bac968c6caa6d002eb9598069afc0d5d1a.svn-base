						...
						<table border="1" cellspacing="0" id="table_view" align="center">
							<tr style="height:height: 30px;font-size: 20px;">
								...
								<tr id="zyjw" style="display:none;">
									...
									<td colspan="6" id="zyjwzxrystzk" >
										<input radio="true" name="zyjwzxrystzk" id="jw" code="sys036" />
									</td>
								</tr>
								<tr id="zhjzyy" style="display: none;">
									<td>就诊医院</td>
									<td colspan="6"><input id="yy" style="height: 46px;"label="就诊医院"  name="zhjzyy"  type="text"></textarea></td>
								</tr>
								<tr>
									<td>是否有精神病</td>
							...
							<tbody id="dzxx">	
								...
								<tr>
									...
									<td colspan="6">
										<div>
											<select name="gdjzdszs" type="text" id="gdjzdszs" getdis="true"label="固定居住地所在省（区、市）" valid="{required:true}">
			      							</select>&nbsp;&nbsp;
			      							<select name="gdjzdszds" type="text" id="gdjzdszds" getdis="true"label="固定居住地所在地（市、州）" valid="{required:true}">
			      								<option value="" selected="selected">---选择盟市---</option>
			      							</select>&nbsp;&nbsp;
			      							<select name="gdjzdszxq" type="text"  id="gdjzdszxq" getdis="true"label="固定居住地所在县（市、区）" valid="{required:true}">
								...
								<tr>
									...
									<td colspan="6">
										<div>
											<select name="hjszs" type="text" id="hjszs" getdis="true" style="margin-left: 48px;"label="户籍所在省（区、市）" valid="{required:true}">
			      							</select>&nbsp;&nbsp;
			      							<select name="hjszds" type="text" id="hjszds" getdis="true"label="户籍所在地（市、州）" valid="{required:true}">
			      								<option value="" selected="selected">---选择盟市---</option>
			      							</select>&nbsp;&nbsp;
			      							<select name="hjszxq" type="text" id="hjszxq" getdis="true"label="户籍所在县（市、区）" valid="{required:true}">
			      								<option value="" selected="selected">---选择旗县---</option>
			      							</select>&nbsp;&nbsp;
			      							...
			      							<input type="checkbox" value="同上" id="isSame" name="isSame">&nbsp;同上
			      						</div>
		      						</td>
								</tr>
							</tbody>
