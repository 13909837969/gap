 ...
 *
 */
@Service("SfsZdjsqkxxcjbService")
public class SfsZdjsqkxxcjbService extends AbstractService {
		...
		if(user!=null) {
			...
			list=dbClient.find(sqladpter, paginate, new RowDataListener() {
				...
				public void processData(BasicMap<String, Object> rowData) {
					...
					rowData.put("zdjlsj", DateUtil.format(rowData.get("zdjlsj"), "yyyy-MM-dd"));
				}
			});
		}
		return list;
