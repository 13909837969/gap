...
<html>
<head>
<title>司法所组织培训情况信息表</title>
<jsp:include page="../ltrhao-common.jsp"></jsp:include>
<script type="text/javascript" src="${localCtx}/json/SfsZzqkxxcjbService.js"></script>
<script type="text/javascript">
$(function(){
	//连接后台Service
	var Service = new SfsZzqkxxcjbService();
	//TableView绘制主界面
...
<!-- 警告提示信息 -->		
		...
		<div id="list_SfsSbzqkxxcjb_Interface">
			...
			<div  field="pxkcmc"	label="培训课程名称" ></div>
			<div  field="pxjb" 	label="培训类别"  code="sys210"></div>
			<div  field="pxxs" 	label="培训学时"></div>
			<div  field="pxrs" 	label="培训人数"></div>
...
<!-- 模态框标题 -->		
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">新增司法所组织培训情况信息</h4>
			</div>
<!-- 模态框内容 -->		
			<div class="modal-body" style="height: 400px; overflow: auto">	
			<div class="modal-body" id="form_myModal" >
				<input type="hidden" name="s_id" id="s_id">
				<input type="text"  name="pxkcmc" label="培训课程名称"  valid="{required:true}"/>
				<input type="text"  name="pxjb" label="培训类别" code="sys210"   valid="{required:true}"/>
				<input type="text"  name="pxkssj" label="培训开始时间" class="form_date" data-date-format="yyyy-MM-dd"  valid="{date:true,required:true}"/>
				<input type="text"  name="pxjssj" label="培训结束时间" class="form_date" data-date-format="yyyy-MM-dd"  valid="{date:true,required:true}"/>
				<input type="text"  name="pxxs" label="培训学时"  valid="{required:true,int:true}"/>
				<input type="text"  name="pxrs" label="培训人数"   valid="{required:true,int:true}"/>
				<input type="text"  name="pxdd" label="培训地点"  valid="{required:true}"/>
				<textarea   name="pxnr" label="培训内容"  maxlength="500" rows="5"  style="resize: none;" valid="{required:true}"></textarea>
...
<!-- 模态框标题 -->		
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title" id="myModalLabel">修改司法所组织培训情况信息</h4>
			</div>
<!-- 模态框内容 -->
			<div class="modal-body" style="height: 400px; overflow: auto">				
			<div class="modal-body" id="form_updata">
					...
					<input type="text"  name="pxrs" label="培训人数"   valid="{required:true,int:true}"/>
					<input type="text"  name="pxdd" label="培训地点"   valid="{required:true}"/>
				<textarea   name="pxnr" label="培训内容"  maxlength="500" rows="5"  style="resize: none;"></textarea>
...
<!-- 模态框标题 -->		
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title" id="myModalLabel">查看司法所组织培训情况信息</h4>
			</div>
<!-- 模态框内容 -->			
			<div class="modal-body" id="form_check">
					<input type="hidden" name="s_id" id="s_id" readonly="readonly">
					<input type="text"  name="pxkcmc" label="培训课程名称"  readonly="readonly"/>
					<input type="text"  name="pxjb" label="培训类别"  readonly="readonly" code="sys210" id="pxjb_jy"/>
					<input type="text"  name="pxkssj" label="培训开始时间" class="form_date" data-date-format="yyyy-MM-dd" readonly="readonly"/>
					<input type="text"  name="pxjssj" label="培训结束时间" class="form_date" data-date-format="yyyy-MM-dd" readonly="readonly"/>
					<input type="text"  name="pxxs" label="培训学时"  readonly="readonly"/>
					<input type="text"  name="pxrs" label="培训人数"  readonly="readonly"/>
					<input type="text"  name="pxdd" label="培训地点"  readonly="readonly"/>
				<textarea   name="pxnr" label="培训内容"  maxlength="500" rows="5"  style="resize: none;" readonly="readonly"></textarea>
