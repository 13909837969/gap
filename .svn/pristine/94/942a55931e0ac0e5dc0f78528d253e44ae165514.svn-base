...
import com.ehtsoft.im.websocket.ReceiveVoiceSocketHandler;
import com.ehtsoft.im.websocket.VoiceSocketInterceptor;

@Deprecated
//@WebServlet(value="/reveiveVoiceWs/*",loadOnStartup = 2 )
public class ReveiveVoiceSocketServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		WebSocketHttpRequestHandler handler = new WebSocketHttpRequestHandler(context.getBean(ReceiveVoiceSocketHandler.class));
