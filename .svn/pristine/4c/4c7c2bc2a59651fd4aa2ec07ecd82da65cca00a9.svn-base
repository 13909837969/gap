...
public class SfszbsbService extends AbstractService {
	...
	public ResultList<BasicMap<String, Object>> find(BasicMap<String, Object> query,Paginate paginate){
		...
		//String sqlstr = "select * from SFS_SFSZBSBXXB";
		String sqlstr="select a.*,b.id ,b.jgbm,b.jgmc from SFS_SFSZBSBXXB a inner join JC_SFXZJGJBXX b on a.s_id = b.id";
	...
	public void deleteOne(String id) {
		String sqlstr="delete from SFS_SFSZBSBXXB where id=?";
