...
<script type="text/javascript">
		$(function(){
			...
			var tqza = new JzTqzacfxxcjbService();
			var form = new Eht.Form({
				selector:"#tqza_field"
			});
			var formsq = new Eht.Form({
				selector:"#tqzacfsq_field",
				autolayout:true	
			});
			//textaera的计数
		   ...
		   //上报数据
			...
			$("#tqza_list_all #spyj_btn").click(function(){
				if(formsp.validate()){	
					tqza.saveSp(formsp.getData(),new Eht.Responder({	
						success:function(){
							table.refresh();
		...
		<div class="modal-dialog modal-lg" >
			<div class="modal-content" >
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">提请治安处罚信息表</h4>
				</div>
		...
		<div class="modal-dialog modal-lg" >
			<div class="modal-content" >
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">提请治安处罚详细信息表</h4>
				</div>
				<div class="modal-body" id="modal-bodyAdd" style="height:510px;overflow-y:auto;overflow-x:hidden;">
					<div id="tqzacf_field">
