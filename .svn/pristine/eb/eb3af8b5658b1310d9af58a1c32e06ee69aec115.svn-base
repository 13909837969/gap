...
<html lang="en">
  <head>
	...
	<script type="text/javascript" src="../../../json/FAAAService.js"></script>
	...
	$(function(){
		...
		tv.loadData(function(page,res){
			et.findAll({ "FAAA03[like]" :$("#txtName").val()},page,res);
		});
		//查询按钮事件
			...
			<div class="padding-md">
				<div class="panel panel-default table-responsive">
					<div class="panel-heading">
						<i class="fa fa-edit fa-lg"></i> 居民诉求
					</div>
					<!-- <div class="col-md-12 col-sm-4">
						<div id="asqpmChart" style="height: 300px; width: 100%"></div>
					</div> -->
					<div class="padding-md crfix">
					<div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix">
					<div class="dataTables_filter"  id="dataTable_filter"><label><div class="input-group pull-right" style="width:200px;"><input type="text"  id="txtName"class="form-control input-sm" placeholder="请输入诉求人姓名" aria-controls="dataTable"><span class="input-group-btn"><button id="qryBtn" class="btn btn-default btn-sm" type="button"><i class="fa fa-search"></i></button></span></div></label></div>
					</div>
					<div id="dg">
						<div field="faaa02" label="内容"   width="350"  align="left"></div>
						<div field="faaa03" label="诉求人"></div>
						<div field="faaa04" label="诉求日期"></div>
						<div field="faaa05" label="联系电话"></div>
						<div field="faaa06" label="处理情况"></div>
						<div field="faaa07" label="处理经办人"></div>
						<div field="faaa09" label="信息是否公开"  code = "[{v:0,d:'不公开'},{v:1,d:'已公开'}]"></div>
