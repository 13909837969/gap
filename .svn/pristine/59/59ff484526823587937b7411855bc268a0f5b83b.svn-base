...
*/
	...
	public ResultList<BasicMap<String, Object>> findFocusService(BasicMap<String, Object> query,Paginate paginate){
		...
		if(user!=null) {
			...
			resultList = dbClient.find(salAdapter, paginate,new RowDataListener() {
				
				@Override
				public void processData(BasicMap<String, Object> rowData) {
					// TODO Auto-generated method stub
					rowData.put("sqfwkssj", DateUtil.format(rowData.get("sqfwkssj"), "yyyy-MM-dd"));
					rowData.put("sqfwjssj", DateUtil.format(rowData.get("sqfwjssj"), "yyyy-MM-dd"));
