...
//		ResultList<BasicMap<String,Object>> resultList = new ResultList<>();
//		String sqlstr = "select a.f_aid,a.f_status,b.f_content from JZ_TZNRGLB a left join IM_GROUP_AFFICHE b on a.f_gaid = b.f_id";
...
//		return resultList;
//	}
	public List<BasicMap<String,Object>> findPersonNotice(BasicMap<String, Object> query,Paginate paginate){
		List<BasicMap<String,Object>> resultList = new ArrayList<>();
		String sqlstr = "select a.f_id,a.f_aid,a.f_status,b.f_content from JZ_TZNRGLB a left join IM_GROUP_AFFICHE b on a.f_gaid = b.f_id";
		SqlDbFilter sqlDbFilter = new SqlDbFilter();
		sqlDbFilter.eq("a.f_status", StringUtil.toEmptyString(query.get("f_status")))
		           .eq("a.f_aid", StringUtil.toEmptyString(query.get("f_aid")))
		           .like("b.f_content", StringUtil.toEmptyString(query.get("f_content")));
		SQLAdapter sqlAdapter = new SQLAdapter(sqlstr);
		sqlAdapter.setFilter(sqlDbFilter);
		resultList = dbClient.find(sqlAdapter, paginate).getRows();
		return resultList;
	}
