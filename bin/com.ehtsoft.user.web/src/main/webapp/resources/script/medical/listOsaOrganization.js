...
//调用toolbar
	...
	var layout = new Eht.Layout({top:{selector:"#top",title:"机构用户设置"},center:{selector:"#infList",border:false}});
	layout.setTitle("top",user.orgname+"机构用户设置");
//表单控制
...
//调用用户信息
	...
	*/
	...
	$("#addSub").click(function(){
		...
		orgform.setData({parentid:user.orgid});
		if(orgform.getData().orgcode==""){
			pos.createBm(user.orgcode,new Eht.Responder({success:function(ds){
