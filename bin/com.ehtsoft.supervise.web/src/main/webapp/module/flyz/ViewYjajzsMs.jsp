...
<script type="text/javascript">
	$(function() {
		...
		//显示隐藏的区域选择
		$("#ViewYjajzsMs_qyss").click(function(){
		...
		/*时间事件*/
		$("#ViewYjajzsMs_kssj").unbind("click").bind("click",function(){
	//日历
...
$("#ViewYjajzsMs_jssj").unbind("click").bind("click",function(){
	//日历
	$(".form_datetime").datetimepicker({
	       format: "yyyy-mm-dd",
	       language:  'zh-CN',
...
<!--表头搜索 总计  -->
		<div class="col-md-12"  style="padding-top:20px;">
			<div class="col-md-5" id="test1">
				<div class="col-md-3">
					<input type="text" class="form-control" id="ViewYjajzsMs_qyss"placeholder="区域搜索">
				</div>
				<div class="col-md-3">
					<input type="text" class="form-control form_datetime" id="ViewYjajzsMs_kssj"placeholder="开始时间">
				</div>
				<div class="col-md-3">
					<input type="text" class="form-control form_datetime" id="ViewYjajzsMs_jssj"placeholder="结束时间">
				</div>
				<div class="col-md-3">
			...
			<div class="col-md-7">
				<div  class="col-md-3">
					<div class="col-md-12" id="text3">
						<p style="margin-top: 15px"><a href="#">内蒙自治区已结案件类型总数</a></p>
						<p>24961件</p>
					</div>
				</div>
				<div  class="col-md-3">
					<div class="col-md-12" id="text3">
						<p style="margin-top: 15px">内蒙自治区挽回损失或取得利益</p>
						<p>24961件</p>
					</div>
				</div>
				...
				<div  class="col-md-3">
					<div class="col-md-12" id="text3">
						<p style="margin-top: 15px">内蒙自治区刑事法律援助已结束案件总数</p>
						<p>24961件</p>
					</div>
				</div>
				...
				<div  class="col-md-3">
					<div class="col-md-12" id="text3">
						<p style="margin-top: 15px">内蒙自治区民事法律援助已结案总数</p>
						<p>24961件</p>
					</div>
				</div>
			</div>	
		...
		<div class="col-md-12" >
			<div class="col-md-9" id="YjajzsMs-div1">
				<div style="background-color: #333;" id="form-YjajzsMs-1" >
					<div class="form-YjajzsMs" style="font-size:20px;">内蒙自治区已结案件总数</div>
					<div id="rofm-YjajzsMs-zs" style="width: 100%;height:360px;"></div>
				</div>
			</div>
			<!-- 3-以结按键承办情况 -->
			<div class="col-md-3" id="YjajzsMs-div2">
				<div style="background-color:#333;" class="form-YjajzsMs-1" >
				<div class="form-YjajzsMs" style="font-size:20px;">内蒙自治区已结案件承办情况</div>
		...
		<div class="col-md-12">
			<div class="col-md-6" id="YjajzsMs-div2">
				<div style="background-color: #333;" class="form-YjajzsMs-1" >
				<div class="form-YjajzsMs" style="font-size:20px;">内蒙自治区已结案件总数的环比率</div>
			...
			<div class="col-md-6" id="YjajzsMs-div2">
				<div style="background-color: #333;" class="form-YjajzsMs-1" >
					<div class="form-YjajzsMs" style="font-size:20px;">内蒙自治区已结案件总数的同比率</div>
