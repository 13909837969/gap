...
<script type="text/javascript">
	$(function() {
		...
		//显示隐藏的区域选择
		$("#ViewZxfsMs_qyss").click(function(){
		...
		/*时间事件*/
				$("#ViewZxfsMs_kssj").unbind("click").bind("click",function(){
			//日历
		...
		$("#ViewZxfsMs_jssj").unbind("click").bind("click",function(){
			//日历
			$(".form_datetime").datetimepicker({
			       format: "yyyy-mm-dd",
			       language:  'zh-CN',
		...
		/**表1-咨询方式总览*/
		var dom = document.getElementById("rofm-ZxfsMs-zs");
				...
				series : [
						{
							...
							data : [ 1, 100, 500, 400, 200, 200, 200, 200, 200,
									200, 200, 200 ,400],
							itemStyle : {
								normal : {
									color : '#0d9bff'
						...
						},
						{
							name : '2017年',
							type : 'bar',
							data : [ 300, 300, 600, 1000, 700, 100, 200, 800, 100,
									500, 500, 500 ,365],
							itemStyle : {
								normal : {
									color : '#f5ce0c'
		...
		//表2，咨询方式环比率
		var dom = document.getElementById("rofm-ZxfsMs-hb");
		var myChart = echarts.init(dom);
		var app = {};
		option = null;
		option = {
		...
		/*表3-咨询方式*/
		var dom = document.getElementById("rofm-ZxfsMs-fl");
...
/*表4-咨询方式同比率*/
		var dom = document.getElementById("rofm-ZxfsMs-tb");
		var myChart = echarts.init(dom);
		var app = {};
		option = null;
...
<!--表头搜索 总计  -->
		<div class="col-md-12" style="padding-top:20px;">
			<div class="col-md-5" id="test1" style="margin-top: 20px">
				<div class="col-md-3">
					<input type="text" class="form-control" id="ViewZxfsMs_qyss" placeholder="区域搜索">
				</div>
				<div class="col-md-3">
						<input type="text" class="form-control form_datetime" id="ViewZxfsMs_kssj"placeholder="开始时间">
				</div>
				<div class="col-md-3">
					<input type="text" class="form-control  form_datetime" id="ViewZxfsMs_jssj"placeholder="结束时间">
				</div>
				<div class="col-md-3">
			...
			<div class="col-md-2">
				<div class="col-md-12" id="text3">
					<p style="margin-top:10px;font-size:18px;"><a href="#">内蒙古自治区咨询人员总数</a></p>
					<p style="margin-top:10px;font-size:18px;">50人</p>
				</div>
			</div>
		</div>
		<!-- 1-咨询方式类型总览图表 -->
		<div class="col-md-12">
			<div class="col-md-7" id="ZxfsMs-div1">
				<div style="background-color: #333;"id="rofm-ZxfsMs-1">
				<div class="form-ZxfsMs"><a href="#">内蒙古自治区咨询方式总览</a></div>
					<div id="rofm-ZxfsMs-zs"style="width: 100%; height: 400px; height: 360px"></div>
				</div>
			</div>
			<!-- 2-咨询方式的环比率 -->
			<div class="col-md-5" id="ZxfsMs-div1">
				<div style="background-color: #333;" id="rofm-ZxfsMs-1">
				<div class="form-ZxfsMs">内蒙古自治区咨询方式的环比率</div>
					<div id="rofm-ZxfsMs-hb"style="width: 100%; height: 400px; height: 360px"></div>
				</div>
			</div>
		</div>
...
<!-- 表3-咨询方式分类 -->		
		<div class="col-md-12">
			<div class="col-md-5" id="ZxfsMs-div2">
				<div style="background-color: #333;" id="rofm-ZxfsMs-1">
				<div class="form-ZxfsMs">内蒙古自治区咨询方式</div>
					<div id="rofm-ZxfsMs-fl"style="width: 100%; height: 400px; height: 360px"></div>
				</div>
			</div>
<!-- 4-咨询方式的同比率 -->
			<div class="col-md-7" id="ZxfsMs-div2">
				<div style="background-color: #333;" id="rofm-ZxfsMs-1">
				<div class="form-ZxfsMs">内蒙古自治区咨询方式的同比率</div>
					<div id="rofm-ZxfsMs-tb"style="width: 100%; height: 400px; height: 360px"></div>
				</div>
			</div>
		</div>
</div>
