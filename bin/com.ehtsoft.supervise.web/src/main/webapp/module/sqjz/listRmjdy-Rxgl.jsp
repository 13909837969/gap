...
$(function() {
	var form = new Eht.Form({
		selector : "#rmjdgl_listKttjaj",
		autolayout:true
	});
	var tableView = new Eht.TableView({
		selector : "#rmjdgl_listKttjaj #tableview",
		//一次选择多个数据
		multable : true
	});
	$("#rmjdgl_listKttjaj #rmtj_id_djan").click(function(data){
		$("#rmjdgl_listKttjaj #myModal").modal({backdrop: 'static', keyboard: false});//弹出模态框
...
<script type="text/javascript">
		$(function(){
			...
			var form1 = new Eht.Form({
				selector:'#rmjdgl_listKttjaj #jzjzlxx-form',
				autolayout:true
				});
			var tableview = new Eht.TableView({
		...
		//单击添加档案数据弹出模态框	
		$('#rmjdgl_listKttjaj #RmjdyLb_button_ck').click(function(){
			$('#rmjdgl_listKttjaj #myModal').modal({backdrop:'static'});
			//默认添加初始界面在最上面输入姓名
		setTimeout(function(){
...
.RmjdyLb_button button:nth-child(1){
	width:50px;
	height:30px;
	border:1px solid #ccc;
	border-radius:4px;
...
.RmjdyLb_button button:nth-child(2){
	width:50px;
	height:30px;
	border:1px solid #ccc;
	border-radius:4px;
...
.RmjdyLb_button button:nth-child(3){
	width:130px;
	height:30px;
	border:1px solid #ccc;
	border-radius:4px;
		...
		<div class="panel panel-default">
					...
					<div id="querypanel">
						...
						<div class="row" id="" style="margin-bottom:10px;text-align:center;">
							<div class="col-md-12 col-sm-12">
								...
								<div class="col-md-3 col-sm-3"><span style="font-weight:bold;">民族:</span>
									<select style="height:30px;border:1px solid #ccc;border-radius:4px;">
									</select>
								</div>
								<div class="col-md-3 col-sm-3"><span style="font-weight:bold;">审核状态:</span><input style="height:30px;border-radius:4px;border:1px solid #ccc;"/></div>
							</div>
						</div>
			...
			<div class="col-md-12">
				<div class="col-md-12"  style="border:1px solid #ccc;border-radius:4px;">
					<div class="RmjdyLb_text " style="margin-bottom:10px;border-bottom:1px solid #ccc;">人民监督员列表</div>
					<div class="RmjdyLb_button " style="margin-bottom:20px;">
						<button>审核</button>
						<button id="RmjdyLb_button_ck">查看</button>
						<button>导出自荐/推荐表</button>
					</div>
						...
						<div class="modal-body pre-scrollable ">
							<div id="jzjzlxx-form">
								<table style="width: 100%; height: 100%; table-layout: fixed;" class="nui-form-table" cellpadding="0" border="0">
									...
									<tr>
										<!-- <td class="form_label">地区:</td>
										<td colspan="1"><input class="nui-dictcombobox" name="sffzgzjdy.szmsid" dictTypeId="SF_FZGZ_SZMS" onvaluechanged="setHidValue(this,'sffzgzjdy.szms')" style="width: 90%;" /> <input
											class="nui-hidden" name="sffzgzjdy.szms" style="width: 90%;" /></td> -->
										<td class="form_label">参加工作年月:</td>
										<td colspan="1">
											<span class="mini-buttonedit mini-datepicker mini-popupedit mini-buttonedit-readOnly asLabel" style="border-width: 0px; width: 90%; padding: 0px;">
												<span class="mini-buttonedit-border">
													<input type="text" class="mini-buttonedit-input" autocomplete="off" placeholder="" readonly=""/>
												...
												<input name="sffzgzjdy.cjgzny" type="hidden" value="2007-12-07"/>
											</span>
										</td>
										<td class="form_label" style="padding: 5px 0px;">身份证号码:</td>
										<td colspan="1">
											<span class="mini-textbox mini-textbox-readOnly asLabel" style="border-width: 0px; width: 120%; padding: 0px;">
												<span class="mini-textbox-border">
													<input type="text" class="mini-textbox-input" autocomplete="off" placeholder="" name="sffzgzjdy.sfzhm" readonly=""/>
												</span>
												<input type="hidden"/>
											</span>
										</td>
										<!-- <td align="center" colspan="2">上传照片</td> -->
									</tr>
									<tr>
										<td class="form_label" style="padding: 5px 0px;">加入党派时间:</td>
										<td colspan="1">
											<span class="mini-buttonedit mini-datepicker mini-popupedit mini-buttonedit-readOnly asLabel" style="border-width: 0px; width: 90%; padding: 0px;">
												<span class="mini-buttonedit-border">
													<input type="text" class="mini-buttonedit-input" autocomplete="off" placeholder="" readonly=""/>
										...
										<td class="form_label">健康状况:</td>
										<td colspan="1"><span class="mini-textbox mini-textbox-readOnly asLabel" style="border-width: 0px; width: 120%; padding: 0px;"><span class="mini-textbox-border"><input type="text" class="mini-textbox-input" autocomplete="off" placeholder="" name="sffzgzjdy.jkzk" readonly=""></span><input type="hidden"></span></td>
									</tr>
									<tr>
										<td class="form_label" style="padding: 5px 0px;">毕业院校及专业:</td>
										<td colspan="5" style="text-align:left; padding-left:9px;"><span class="mini-textbox mini-textbox-readOnly asLabel" style="border-width: 0px; width: 90%; padding: 0px;"><span class="mini-textbox-border"><input type="text" class="mini-textbox-input" autocomplete="off" placeholder="" name="sffzgzjdy.byyxzy" readonly=""></span><input type="hidden"></span></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td colspan="1"><span class="mini-textbox mini-textbox-readOnly asLabel" style="border-width: 0px; width: 90%; padding: 0px;"><span class="mini-textbox-border"><input type="text" class="mini-textbox-input" autocomplete="off" placeholder="" name="sffzgzjdy.yb" readonly=""></span><input type="hidden"></span></td>
									</tr>
									<tr>
										<td class="form_label">联系电话:</td>
										<td colspan="1"><span class="mini-textbox mini-textbox-readOnly asLabel" style="border-width: 0px; width: 90%; padding: 0px;"><span class="mini-textbox-border"><input type="text" class="mini-textbox-input" autocomplete="off" placeholder="" name="sffzgzjdy.phone" readonly=""></span><input type="hidden"></span></td>
										<td class="form_label" style="padding: 5px 0px;">手机号码:</td>
										<td colspan="1"><span class="mini-textbox mini-textbox-readOnly asLabel" style="border-width: 0px; width: 90%; padding: 0px;"><span class="mini-textbox-border"><input type="text" class="mini-textbox-input" autocomplete="off" placeholder="" name="sffzgzjdy.sjhm" readonly=""></span><input type="hidden"></span></td>
										<td class="form_label">电子邮箱:</td>
										<td colspan="1"><span class="mini-textbox mini-textbox-readOnly asLabel" style="border-width: 0px; width: 90%; padding: 0px;"><span class="mini-textbox-border"><input type="text" class="mini-textbox-input" autocomplete="off" placeholder="" name="sffzgzjdy.dzyx" readonly=""></span><input type="hidden"></span></td>
									</tr>
									<tr>
									...
									<tr>
										<td class="form_label" style="padding: 5px 0px;">简历:</td>
										<td colspan="5" style="text-align:left; padding-left:9px;"><span class="mini-textbox mini-textarea mini-textbox-readOnly asLabel" style="border-width: 0px; width: 90%; padding: 0px;"><span class="mini-textbox-border" style="border:0px;"><textarea class="mini-textbox-input" autocomplete="off" placeholder="" name="sffzgzjdy.jl" readonly="" style="height: 48px;"></textarea></span><input type="hidden"></span></td>
									</tr>
									<tr>
										<td class="form_label" style="padding: 5px 0px;display:none;" id="bx1">主要工作表现:</td>
										<td colspan="5" id="bx2" style="display:none;text-align:left; padding-left:9px;">
											<span class="mini-textbox mini-textarea mini-textbox-readOnly asLabel" style="border-width: 0px; width: 90%; padding: 0px;"><span class="mini-textbox-border" style="border:0px;"><textarea class="mini-textbox-input" autocomplete="off" placeholder="" name="sffzgzjdy.zygzbx" readonly=""></textarea></span><input type="hidden"></span>
										</td>
									</tr>
									<tr>
										<td class="form_label" style="padding: 5px 0px;">家庭成员及主要社会关系:</td>
										<td colspan="5" style="text-align:left; padding-left:9px;"><span class="mini-textbox mini-textarea mini-textbox-readOnly asLabel" style="border-width: 0px; width: 90%; padding: 0px;"><span class="mini-textbox-border" style="border:0px;"><textarea class="mini-textbox-input" autocomplete="off" placeholder="" name="sffzgzjdy.cygx" readonly="" style="height: 48px;"></textarea></span><input type="hidden"></span></td>
									</tr>
									<tr>
										<td class="form_label" style="padding: 5px 0px;">原人民监督员证书编号:</td>
										<td colspan="1"><span class="mini-textbox mini-textbox-readOnly asLabel" style="border-width: 0px;"><span class="mini-textbox-border"><input type="text" class="mini-textbox-input" autocomplete="off" placeholder="原人民监督员填写" name="sffzgzjdy.yzs" readonly=""></span><input type="hidden"></span></td>
										<td class="form_label">任职时间:</td>
										<td colspan="1"><span class="mini-buttonedit mini-datepicker mini-popupedit mini-buttonedit-readOnly asLabel" style="border-width: 0px;"><span class="mini-buttonedit-border"><input type="text" class="mini-buttonedit-input" autocomplete="off" placeholder="原人民监督员填写" readonly=""><span class="mini-buttonedit-buttons"><span class="mini-buttonedit-close"></span><span class="mini-buttonedit-button" onmouseover="mini.addClass(this, 'mini-buttonedit-button-hover');" onmouseout="mini.removeClass(this, 'mini-buttonedit-button-hover');"><span class="mini-buttonedit-icon"></span></span></span></span><input name="sffzgzjdy.rzsj" type="hidden"></span></td>
									</tr>
									<tr>
										<td class="form_label" style="padding: 5px 0px;">担任原人民监督员履职情况:</td>
										<td colspan="5" style="text-align:left; padding-left:9px;"><span class="mini-textbox mini-textarea mini-textbox-readOnly asLabel" style="border-width: 0px; width: 90%; padding: 0px;"><span class="mini-textbox-border" style="border:0px;"><textarea class="mini-textbox-input" autocomplete="off" placeholder="原人民监督员填写" name="sffzgzjdy.ylzqk" readonly="" style="height: 48px;"></textarea></span><input type="hidden"></span></td>
									</tr>
								</tbody>
							</table>
						</div>
