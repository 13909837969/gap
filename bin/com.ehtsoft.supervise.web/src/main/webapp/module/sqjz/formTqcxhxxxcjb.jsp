				...
				<div class="modal-content">
					...
					<div class="modal-body" id="modal-body" style="height: 510px; overflow: auto">
						<div id="tqsp_form">   
								...
								<textarea  rows="6" id="tqly" name="tqly" label="提请理由" type="text" disabled></textarea>
								<div class="text-right"><span style="color: #3F51B5"></span></div>
								<textarea rows="6" id="tqyj" name="tqyj" label="提请依据" type="text" disabled ></textarea>
								<div class="text-right"><span style="color: #3F51B5"></span></div>	
								<input type="text" id="xsfjspr" name="xsfjspr"   label="审核人" value="${CURRENT_USER_SESSION.name}" readonly="true" fixedValue="true" >					
								<input type="text" id="xsfjspsj" name="xsfjspsj" label="审核时间" class="form_date" readonly="readonly">
								<textarea rows="6" id="xsfjshyj" name="xsfjshyj" label="审核意见" type="text" getdis="true"></textarea>
