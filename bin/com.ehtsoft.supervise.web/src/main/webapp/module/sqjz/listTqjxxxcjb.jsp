...
$(function(){
	...
	var tableview = new Eht.TableView({
		selector:"#sqjz_Tqjxxx #tableview"
	});
	//审核记录
	var tableViewshjl = new Eht.TableView({
		selector:"#sqjz_Tqjxxx #tableview_shjl",
		paginate:null
	});
	...
	//查询按钮
	$("#sqjz_Tqjxxx #querybtn").click(function(){
		query.audit = $("#listJgxxcjbSelt").val();
		query["xm[like]"] = $("#searchXm").val(); 
		tableview.refresh();
	});
	//点击添加上报弹出模态框
	$('#sqjz_Tqjxxx #addbtn').click(function(){
		//动态添加矫正人员
	...
	//提交减刑信息
	$("#sqjz_Tqjxxx #btn_submit").click(function(){
		if(form.validate()){
					...
					$('#sjzx_modal').modal({backdrop:'static'});
		        	 ...
		        	 //将数据填充到审核记录
		   			tableViewshjl.loadData(function(page,res){
		   				service.getAuditHistory(ds.id,res);//参数
	...
	//关闭按钮事件  清除未选择的数据
	$("#sqjz_Tqjxxx #close #zaxx_modal_form").click(function(){
	       form.clear();
	       tableview.refresh();	
	...
	//提请理由
	var textareaName = "#sqjz_Tqjxxx #floor";//备注输入框id
	var spanName = "#sqjz_Tqjxxx #count";//计数span的id
	...
	//提请依据
	var textareaName2 = "#sqjz_Tqjxxx #floor2";//备注输入框id
	var spanName2 = "#sqjz_Tqjxxx #count2";//计数span的id
	...
	//审核意见
	var textareaName3 = "#sqjz_Tqjxxx #floor3";//备注输入框id
	var spanName3 = "#sqjz_Tqjxxx #count3";//计数span的id
			...
			<div class="modal-dialog ">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">添加减刑信息</h4>
					</div>
