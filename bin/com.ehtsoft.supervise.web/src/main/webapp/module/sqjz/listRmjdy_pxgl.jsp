		...
		<div class="panel panel-default">
			<div>
				<fieldset  class="panel-body">
					<div id="querypanel">
						<div class="row" id="Rmtjjdy_icon"><span class="im-search3"></span><span class="Rmtjjdy_icon_span">培训内容查询</span></div>
			...
			<div class="col-md-12">
				<div class="col-md-12"  style="border:1px solid #ccc;border-radius:4px;">
					<div class="RmjdyLb_text " style="margin-bottom:10px;">人民监督员培训列表</div>
