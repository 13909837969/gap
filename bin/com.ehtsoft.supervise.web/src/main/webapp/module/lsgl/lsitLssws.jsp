...
<script type="text/javascript" src="${localCtx}/json/LsswsxxService.js"></script>
<script type="text/javascript" src="${localCtx}/json/RegionService.js"></script>
<script type="text/javascript">
	$(function() {
		//链接Service
		var Service = new LsswsxxService();
		//左侧col-md-3内容排版
		...
		$("#lszhglLsxxhq_list #submit").click(function(){
			console.log();
			query["lsswsmc"]= $("#lsswsmc1").val();
			query["ywmc"] = $("#ywmc1").val();
			query["fzrid1"] = $("#fzrid").val();
			query["hhrid"] = $("#hhrid1").val();
			query["zgjgid"] = $("#zgjgid1").val();
			query["fzjg"] = $("#fzjg1").val();
			query["dzzmc"] = $("#dzzmc1").val();
			tableView.refresh();
		});
		//重置按钮
...
<!-- 左侧查询信息 -->
	...
	<div  class="col-md-3" style="top:30px;height:800px;border: 1px solid #ccc;border-radius: 5px;position:fixed;"  >
		<div class="col-md-12 " style="text-align:center;">
			<p  class="glyphicon glyphicon-user"  style="font-size:18px;margin-top: 10px;padding-left:20px;">律师事务所信息查询</p>
			...
			<div class="list-form-style col-md-12" style="padding-top:20px; ">
				<form id="form_lsxxhq" style="margin-bottom:0px; ">
					...
					<input type="text"  id="lsswsmc1"	 name="lsswsmc" 	label="律师事务所名称" 	maxlength="30"  />
					<input type="text"  id="ywmc1"	 	 name="ywmc" 		label="英文名称" 	maxlength="30"  />
					<input type="text"  id="fzrid1"	 	 name="fzrid" 		label="负责人" 	maxlength="30"  />
					<input type="text"  id="hhrid1"	 	 name="HHRID" 		label="合伙人" 	maxlength="30"  />
					<input type="text"  id="zgjgid1"	 name="zgjgid" 		label="主管机关" 	maxlength="30"  />
					<input type="text"  id="fzjg1"	 	 name="fzjg" 		label="发证机关" 	maxlength="30"  />
					<input type="text"  id="dzzmc1"	 	name="dzzmc" 	label="党组织名称" 	maxlength="30"  />
					<div class="col-md-12" style="padding-top:150px;margin-bottom:10px;">
					<hr style=" height:1px;border:none;border-top:1px dashed #ccc"/>
			...
			<div class="col-md-12" style="border:1px solid #ccc;border-radius:4px;margin-top: 30px;">
				<div class="col-md-12">
					<div class="row" style="height:40px;padding-top:5px;border-bottom:1px solid #ccc;">
						<div class="col-md-3 glyphicon glyphicon-tasks" id="sjqk"  style="font-size:18px;" ><span style="padding-left:10px;">律师数据分析情况</span></div>
				...
				<div class="col-md-12"  id="table_view" style="padding-left:15px;">		
					<div class="col-md-4" style="height:230px;" >
						<div   class="form-AjlxMs-1 col-md-12">
							<div class="form-AjlxMs" style="font-size:16px;">律师事务所类别情况</div>
							<div class="col-md-12"  style="margin-top:30px;height:30px;">
								<div class="col-md-6">
									<div class="form-AjlxMs" style="font-size:14px;padding-top:0px;line-height:30px;">内蒙古律师所</div>
								</div>
								<div class="col-md-6">
							...
							<div class="col-md-12"  style="margin-top:20px;height:30px;">
								<div class="col-md-6">
									<div class="form-AjlxMs" style="font-size:14px;padding-top:0px;line-height:30px;">呼和浩特律师所</div>
								</div>
								<div class="col-md-6">
...
<!-- 隐藏的Echars视图 -->
		<div class="col-md-12"  id="table_view_hide" style="padding-left:15px;">		
				...
				<div class="col-md-4" id="ZxfsMsQX-div2" style="id="table_view">
							<div  class="rofm-ZxfsMsQX-1">
							<div class="form-AjlxMs">文化程度状况</div>
...
<!-- 查询的内容 -->
	<div id="list_lsxxhq" style="margin-top: 10px;text-align:center;">
				<div field="lsswsmc"  	name="lsswsmc" 	label="律师事务所名称"></div>
				<div field="ywmc" 		name="ywmc"		label="英文名称" ></div>
				<div field="fzrid" 		name="fzrid"	label="负责人"></div>
				<div field="zyzh" 		name="zyzh"		label="执业证号"></div>
				<div field="zsd" 		name="zsd"		label="住所地"></div>
				<!-- <div field="zsdz" 		name="zsdz"		label="住所地址" ></div> -->
				<div field="lxdh" 		name="lxdh"		label="联系电话"></div>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content" style="position:absolute; height:650px; overflow:auto">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">律师事务所信息明细</h4>
					</div>
					<div class="modal-body">
						<div id="jzjzlxx-form" >
							<!-- <input type="text" name="F_AID"	label="律师事务所ID"  disabled/> -->
							<input type="text" name="LSSWSMC"			label="律师事务所名称"  disabled/>
							<!-- <input type="text" name="ZTID"	label="主题ID" disabled> -->
							<input type="text" name="YWMC"				label="英文名称"  disabled/>
							<input type="text" name="PY"				label="拼音"  disabled/>
							<input type="text" name="JC"				label="简称"  disabled/>
							<input type="text" name="TYSHXYDM"			label="统一社会信用代码"  disabled/>
							<input type="text" name="ZGJGID"			label="主管机关"  disabled/>
							<input type="text" name="ZSD"				label="住所地"  disabled/>
							<input type="text" name="ZSDZ"				label="住所地址"  disabled/>
							<input type="text" name="ZSYB"				label="住所邮编"  disabled/>
							<input type="text" name="LXDH"				label="联系电话"  disabled/>
							<input type="text" name="CZ"				label="传真"  disabled/>
							<input type="text" name="DWWZ"				label="单位网站"  disabled/>
							<input type="text" name="DZYX"				label="电子邮箱"  disabled/>
							<input type="text" name="ZYZH"				label="职业证号"  disabled/>
							<input type="text" name="ZZXS"				label="组织形式"  disabled/>
							<input type="text" name="DZZMC"				label="党组织名称"  disabled/>
							<input type="text" name="DZZXS"				label="总分所形式"  disabled/>
							<input type="text" name="PZSLSJ"			label="批准设立时间"  disabled/>
							<input type="text" name="PZWH"				label="批准文号"  disabled/>
							<input type="text" name="KHNF"				label="考核年份"  disabled/>
							<input type="text" name="KHZT"				label="考核状态"  disabled/>
							<input type="text" name="HHRID"				label="合伙人"  disabled/>
							<input type="text" name="FZRQ"				label="发证日期"  disabled/>
							<input type="text" name="FZJG"				label="发证机关"  disabled/>
							<input type="text" name="SLZC"				label="设立资产"  disabled/>
							<!-- <input type="text" name="xm"	label="LOGO"  disabled/> -->
							<!-- <input type="text" name="xm"	label="总所 ID"  disabled/> -->
							<input type="text" name="xm"	label="机构简介"  disabled/>
							<input type="text" name="ywzc"	label="业务专长" disabled/>
						</div>
					</div>
