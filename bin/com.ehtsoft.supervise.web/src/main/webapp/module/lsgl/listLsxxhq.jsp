...
<script type="text/javascript" src="${localCtx}/json/lszhglLsxxhqService.js"></script>
<script type="text/javascript" src="${localCtx}/json/RegionService.js"></script>
<script type="text/javascript">
	$(function() {
		//链接Service
		var Service = new lszhglLsxxhqService();
		//左侧col-md-3内容排版
		...
		$("#lszhglLsxxhq_list #submit").click(function(){
			...
			query["csrq_ks"] = $("#csrq_ks1").val();
			query["csrq_js"] = $("#csrq_js1").val();
			query["fzrq_ks"] = $("#fzrq_ks1").val();
			query["fzrq_js"] = $("#fzrq_js1").val();
			query["mz"] = $("#mz1").val();
			query["xb"] = $("#xb1").val();
			query["zgxl"] = $("#zgxl1").val();
		...
		<div class="col-md-12 " style="text-align:center;">
			...
			<div class="list-form-style col-md-12" style="padding-top:20px; ">
				<form id="form_lsxxhq" style="margin-bottom:0px; ">
					...
					<input type="text"  id="csrq_ks1"	 name="csrq_ks" 	label="年龄开始时间"	 	maxlength="30"  />
					<input type="text"  id="csrq_js1"	 name="csrq_js" 	label="年龄结束时间"	 	maxlength="30"  />
					<input type="text"  id="fzrq_ks1"	 name="fzrq_ks" 	label="证书开始时间"	 	maxlength="30"  class="form_date" data-date-formate="yyyy-MM-dd" />
					<input type="text"  id="fzrq_js1"	 name="fzrq_js" 	label="证书结束时间"	 	maxlength="30"  class="form_date" data-date-formate="yyyy-MM-dd" />
					...
					<input type="text"  id="zgxl1"	 	name="zgxl"			label="最高学历" 		maxlength="30"	code="sys093" /> 
...
<!-- 隐藏的Echars视图 -->
		<div class="col-md-12"  id="table_view_hide" style="padding-left:15px;">		
				...
				<div class="col-md-4" id="ZxfsMsQX-div2" 1 id="table_view">
							<div  class="rofm-ZxfsMsQX-1">
							<div class="form-AjlxMs">文化程度状况</div>
				...
				<div class="modal-content" style="position:absolute; height:650px; overflow:auto">
					...
					<div class="modal-body">
						<div id="jzjzlxx-form" >
							...
							<input type="text" name="xb"	id="xbjy" label="性别"  disabled   code="sys000" />
							<input type="text" name="cym"	label="曾用名" 	 disabled/>
							<input type="text" name="csrq"	label="出生日期" 	  disabled/>
							<input type="text" name="mz"	 id="mzjy" label="民族"     code="sys003" />
							<input type="text" name="jg"	label="籍贯" 	  disabled/>
							<input type="text" name="zyjg"	label="执业机构" 	  disabled/>
							<input type="text" name="zylb"	label="执业类别" 	 disabled/>
							<input type="text" name="zyzh"	label="执业证号" 	  disabled/>
							<input type="text" name="snsf"	label="所内身份" 	  disabled/>
							<input type="text" name="zyzt"	label="执业状态" 	  disabled/>
							<input type="text" name="pzzt"	label="派驻状态" 	  disabled/>
							<input type="text" name="zgzlb"	label="资格证类别" 	  disabled/>
							<input type="text" name="qdfs"	label="取得方式" 	  disabled/>
							<input type="text" name="zgzh"	label="资格证号" 	  disabled/>
							<input type="text" name="zgzqdsj"	label="资格证取得时间" 	  disabled/>
							<input type="text" name="zgzqdd"	label="资格证取得地" 	  disabled/>
							<input type="text" name="zzmm"	id="zzmmjy" label="政治面貌" 	 code="sys091"  disabled/>
							<input type="text" name="hjszd"	label="户籍所在地" 	  disabled/>
							<input type="text" name="byyx"	label="毕业院校" 	  disabled/>
							<input type="text" name="zgxl"	id="zgxljy"  label="最高学历" 	valid="{required:true}"  disabled  code="sys093"/>
							<input type="text" name="zgxw"	label="最高学位" 	  disabled/>
							<input type="text" name="zjlb"	label="证件类别" 	  disabled/>
							<input type="text" name="zjbh"	label="证件编号" 	  disabled/>
							<input type="text" name="lxdz"	label="联系地址" 	  disabled/>		
							<input type="text" name="lxdzyb"	label="联系地址邮编" 	  disabled/>
							<input type="text" name="lxdh"	label="联系电话" 	  disabled/>
							<input type="text" name="dzyx"	label="电子邮箱" 	  disabled/>
							<input type="text" name="sczyrq"	label="首次执业日期" 	  disabled/>
							<input type="text" name="sczyd"	label="首次执业地" 	  disabled/>
							<input type="text" name="khnf"	label="考核年份" 	  disabled/>
							<input type="text" name="khzt"	label="考核状态" 	  disabled/>
							<input type="text" name="rsdacfd"	label="人事档案存放地" 	  disabled/>
							<input type="text" name="rsdacfjg"	label="人事档案存放机构" 	  disabled/>
							<input type="text" name="rsdabh"	label="人事档案编号" 	  disabled/>
							<input type="text" name="rsdacfjg"	label="兼职单位" 	  disabled/>
							<input type="text" name="zyfw"	label="执业范围" 	  disabled/>
							<input type="text" name="zydaqk"	label="执业档案情况" 	 disabled/>
							<input type="text" name="lslx"	label="律师类型" 	  disabled/>
						</div>
					</div>
