...
<body>
	...
	%>
	<div class="text-center lead">社区矫正人员违规信息采集表</div>
	<div id="sqjz_formSqjzryjbxx" class="container-fluid">
		...
		<div class="tab-content col-sm-12" >
			...
			<div id="formJ">
					...
					<input id="yzzmm" type="text" label="违规类型" name="yzzmm" getdis="true"  code="sys025"/>
					<input id="dwhm" type="text" label="违规时间" name="dwhm" getdis="true"/>
					<input id="hjdsfyjzdxt" type="text" label="违规详情" name="hjdsfyjzdxt" getdis="true"  />
					<input id="hjdsfyjzdxt" type="text" label="扣分值" name="hjdsfyjzdxt" getdis="true"  />
			</div>
			</div>
		</div>
		<div>
