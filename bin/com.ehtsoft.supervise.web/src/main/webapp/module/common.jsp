...
<script type="text/javascript" src="<%=ctx%>/resources/script/core/eht.ui.windowmanager.js"></script>
<script type="text/javascript" src="<%=ctx%>/resources/script/core/eht.ui.taskbar.js"></script>
<script type="text/javascript" src="<%=ctx%>/resources/script/core/eht.ui.desktop.js"></script>
