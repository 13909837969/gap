...
<form class="form-inline" style="margin:10px;">
  <div id="divcx">
	...
	<div class="form-group" style="margin-left:10px">
		<label for="khfzr">负责人</label>
		<input type="text" class="form-control" name="khfzr[like]" id="khfzr" placeholder="考核负责人" style="width:100px" >
	</div>
	<div class="form-group" style="margin-left:10px;">
		<label for="nd">年度</label>
		<input type="date" class="form-control" name="nd[ike]" id="nd" placeholder="年度"  style="width:134px">
	</div>
	<div class="form-group" style="margin-left:10px;">
		<label for="qzrq">签字日期</label>
		<input type="date" class="form-control" name="qzrq[like]" id="qzrq" placeholder="签字日期" style="width:134px">
	</div>
			...
			<div class="modal-body" style="overflow: auto; height: 450px;">
				<div class="modal-body-div">
					<div id="jcflfwsForm">
						...
						<select id="jzryxx_xmajglx" name="azbjrybh" label="姓名"></select>
						<!-- 添加信息-->
						<input name="nd" type="date" label="年度" valid="{required:true}" > 
						...
						<input type="date" name="qzrq"  class="form_date" data-date-formate="yyyy-MM-dd" label="签字日期" placeholder="签字日期" >
					</div>
				</div>
			</div>
