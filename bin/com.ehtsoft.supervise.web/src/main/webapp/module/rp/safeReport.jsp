...
<html lang="en">
  <head>
	...
	<script type="text/javascript" src="js/myEchart/safeReport.js"></script> 
	...
	$(function(){
		...
		tv.loadData(function(page,res){
			et.findAll({ "eaaa02[like]" :$("#txtName").val().trim(),"eaaa09[eq]":$("#clqk").val()},page,res);
		});
		//查询按钮事件
			...
			<div class="padding-md">
				<div class="panel panel-default table-responsive">
					<div class="panel-heading">
						<i class="fa fa-dashboard fa-lg"></i> 安全隐患
					</div>
					<!--安全隐患类型 道路施工、天然气泄露-->
					<div class="col-md-4 col-sm-4">
						<div id="syhlxChart" style="height: 200px; width: 100%"></div>
					</div>
					<!-- 处理结果  已处理、未处理-->
					<div class="col-md-4 col-sm-4">
						<div id="scljgChart" style="height: 200px; width: 100%"></div>
					</div>
					<!--上报类型   居民或社区-->
					<div class="col-md-4 col-sm-4">
						<div id="ssblxChart" style="height: 200px; width: 100%"></div>
					</div>
					<div class="padding-md crfix">
					<div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix">
					<div class="dataTables_filter form-inline"  id="dataTable_filter">
					 				<div class="input-group" style="width:80px;">
								                  处理结果：
					 				</div>
									<div class="input-group" style="width:100px;margin-right:8px;">
								                  <select  id="clqk"  class="form-control input-sm"  >
									...
									<div class="input-group pull-right" style="width:200px;">
								        <input type="text"  id="txtName"  class="form-control input-sm" placeholder="请输入安全隐患标题"   aria-controls="dataTable">
								        <span class="input-group-btn"><button id="qryBtn" class="btn btn-default btn-sm" type="button"><i class="fa fa-search"></i></button></span>
					        		</div>
					 				</div>
					</div>
					<div id="dg">
						<!-- <div field="eaaa02" label="标题"   width="200"  align="left"></div> -->
						<div field="eaaa03" label="位置（地址）"   width="320"  align="left"></div>
						<div field="eaaa04" label="描述"   width="230"  align="left"></div>
						<div field="eaaa05" label="类型"    code="csm007"></div>
						<div field="eaaa06" label="上报人" ></div>
						<!-- <div field="aaab03" label="联系电话" ></div> -->
						<div field="eaaa07" label="否已上报"  code = "[{v:0,d:'未上报'},{v:1,d:'已上报'},{v:2,d:'被退回'},{v:4,d:'退回至居民'}]"></div>
						<div field="eaaa08" label="是否公开"   code = "[{v:0,d:'不公开'},{v:1,d:'已公开'}]"></div>
						<div field="eaaa09" label="是否已解决"  code = "[{v:0,d:'未解决'},{v:1,d:'已解决'}]"></div>
						<div field="eaaa10" label="上报人类型"   code = "[{v:0,d:'网格员'},{v:1,d:'居民'}]"></div>
						<div field="orgname" label="所属社区"></div>
						<div field="cts" label="上报时间"></div>
					</div>
					</div><!-- /.padding-md -->
				</div><!-- /panel -->
			</div><!-- /.padding-md -->
