...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" src="js/myEchart/childManager.js"></script>
	...
	<script type="text/javascript" src="../../../json/BAAAETService.js"></script>
	...
	$(function(){
		...
		tv.loadData(function(page,res){
			et.find({ "BAAA_ET05[like]" :$("#txtName").val().trim()},page,res);
		});
		//查询按钮事件
  ...
  <body>
			...
			<div class="padding-md">
				<div class="panel panel-default table-responsive">
					<div class="panel-heading">
						<i class="fa fa-bookmark fa-lg"></i> 儿童信息
						<!-- <span class="label label-info pull-right">790 项目</span> -->
					</div>
					<!--性别 -->
					<div class="col-md-4 col-sm-4">
						<div id="cxbChart" style="height: 200px; width: 100%"></div>
					</div>
					<!--户口性质 -->
					<div class="col-md-4 col-sm-4">
						<div id="chkxjChart" style="height: 200px; width: 100%"></div>
					</div>
					<!--居住性质 -->
					<div class="col-md-4 col-sm-4">
						<div id="cjzxzChart" style="height: 200px; width: 100%"></div>
					</div>
					...
					<div id="dg">
						<div field="baaa_et05" label="姓名"></div>
						<div field="baaa_et06" label="性别"  width="60"></div>
						<div field="baaa_et07" label="出生日期"></div>
						<div field="baaa_et09" label="民族"></div>
						<div field="baaa_et10" label="户口性质"></div>
						<div field="baaa_et11" label="居住性质"></div>
						<div field="baaa_et14" label="父亲姓名"></div>
						<div field="baaa_et15" label="母亲姓名"></div>
						<div field="baaa_et19" label="现居住地"    width="380"  align="left"></div>
    ...
    <!-- Le javascript
    ================================================== -->
    <!-- Placed at the end of the document so the 社区资源管理s load faster -->
	<script src="js/jquery-1.10.2.min.js"></script>
