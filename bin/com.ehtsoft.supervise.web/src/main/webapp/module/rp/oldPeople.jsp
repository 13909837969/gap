...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" src="js/myEchart/oldPeople.js"></script>
	...
	<script type="text/javascript" src="../../../json/BAAALNRService.js"></script>
	...
	$(function(){
		...
		tv.loadData(function(page,res){
			lnr.find({ "BAAA_LNR02[like]" :$("#txtName").val().trim()},page,res);
		});
		//查询按钮事件
			...
			<div class="padding-md">
				<div class="panel panel-default table-responsive">
					<div class="panel-heading">
						<i class="fa fa-user fa-lg"></i> 老年人信息管理
						<!-- <span class="label label-info pull-right">790 项目</span> -->
					</div>
					<!--性别 -->
					<div class="col-md-4 col-sm-4">
						<div id="oxbChart" style="height: 200px; width: 100%"></div>
					</div>
					<!--户口性质 -->
					<div class="col-md-4 col-sm-4">
						<div id="ohkxjChart" style="height: 200px; width: 100%"></div>
					</div>
					<!--居住性质 -->
					<div class="col-md-4 col-sm-4">
						<div id="ojzxzChart" style="height: 200px; width: 100%"></div>
					</div>
					<!--老年化小区排名 -->
					<div class="col-md-12 col-sm-4">
						<div id="oxqpmChart" style="height: 300px; width: 100%"></div>
					</div>
					...
					<div id="dg">
						<div field="baaa_lnr02" label="姓名"></div>
						<div field="baaa_lnr03" label="性别"></div>
						<div field="baaa_lnr04" label="出生日期"></div>
						<div field="baaa_lnr05" label="身份证号"></div>
						<div field="baaa_lnr06" label="是否单身"></div>
						<div field="baaa_lnr07" label="详细地址（住址）"  width="280"  align="left"></div>
