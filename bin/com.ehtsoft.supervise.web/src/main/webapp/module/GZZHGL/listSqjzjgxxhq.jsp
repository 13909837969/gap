...
<script type="text/javascript" src="${localCtx}/json/SqjzjgxxhqService.js"></script>
<script type="text/javascript" src="${localCtx}/json/RegionService.js"></script>
<script type="text/javascript">
	$(function() {
		//链接Service
		var Service = new SqjzjgxxhqService();
		//左侧col-md-3内容排版
		...
		$("#lszhglLsxxhq_list #submit").click(function(){
			console.log();
			query["fzr"]= $("#fzr1").val();
			query["jgbm"]= $("#zyjg1").val();
			query["jgmc"] = $("#fzr1").val();
			query["jgjc"] = $("#jgjc1").val();
			query["jgdm"] = $("#jgdm1").val();
			query["jglb"] = $("#jglb1").val();
	   ...
	   $('#remain_lsxxhq_1').click(function () {
		...
		//模态框select禁用
		$("#jglbjy").attr("disabled","disabled");
		$("#jgxzjbjy").attr("disabled","disabled");
		$("#jglscjiy").attr("disabled","disabled");
...
<!-- 左侧查询信息 -->
	...
	<div  class="col-md-3" style="top:30px;height:100%;border: 1px solid #ccc;border-radius: 5px;position:fixed;" >
		<div class="col-md-12 " style="text-align:center;">
			<p  class="glyphicon glyphicon-home"  style="font-size:18px;margin-top: 10px;padding-left:20px;">&nbsp;社区矫正机构信息查询</p>
			...
			<div class="list-form-style col-md-12" style="padding-top:20px; ">
				<form id="form_lsxxhq" style="margin-bottom:0px; ">
					...
					<input type="text"  id="jgbm1"	 name="jgbm" 	label="机构编码" 	maxlength="30"  />
					<input type="text"  id="jgmc1"	 name="jgmc" 	label="机构名称" 	maxlength="30"  />
					<input type="text"  id="zyzh1"	 name="jgjc" 	label="机构简称" 	maxlength="30"  />
					<input type="text"  id="jgdm1"	 name="jgdm" 	label="机构代码" 	maxlength="30"  />
					<input type="text"  id="jglb1"	 name="jglb" 	label="机构类别" 	maxlength="30"  />
...
<!-- 表头 -->
			<div class="col-md-12" style="border:1px solid #ccc;border-radius:4px;margin-top: 30px;">
				...
				<div class="row" style="height:40px;padding-top:5px;border-bottom:1px solid #ccc;">
					<div class="col-md-3 glyphicon glyphicon-home" id="sjqk"  style="font-size:18px;color:#333;" ><span style="color:#333;padding-left:10px;">公证机构信息分析情况</span></div>
			...
			<div class="col-md-12"  id="table_view" style="padding-left:15px; ">		
				<div class="col-md-4" style="height:230px;" >
					<div   class="form-AjlxMs-1 col-md-12">
						<div class="form-AjlxMs" style="font-size:16px;">社区矫正机构类别情况</div>
						<div class="col-md-12"  style="margin-top:30px;height:30px;">
							<div class="col-md-7">
								<div class="form-AjlxMs" style="font-size:14px;padding-top:0px;line-height:30px;">内蒙古矫正机构</div>
							</div>
							<div class="col-md-5">
						...
						<div class="col-md-12"  style="margin-top:20px;height:30px;">
							<div class="col-md-7">
								<div class="form-AjlxMs" style="font-size:14px;padding-top:0px;line-height:30px;">呼和浩特矫正机构</div>
							</div>
							<div class="col-md-5">
...
<!-- 查询的内容 -->
	<div id="list_lsxxhq" style="margin-top: 10px">
				<div field="jgbm"  	name="jgbm" 		label="机构编码" ></div>
				<div field="jgmc"  	name="jgmc" 		label="机构名称" ></div>
				<div field="jgjc"  	name="jgjc" 		label="机构简称" ></div>
				<div field="ywmc"  	name="ywmc" 		label="英文名称" ></div>
				<div field="jglb"  	name="jglb" 		label="机构类别"		code="SYS004" ></div>
				<div field="jgxzjb" name="jgxzjb" 		label="机构行政级别" 	code="SYS006"></div>
				<div field="fzr"  	name="fzr" 			label="负责人" ></div>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content" style="position:absolute; height:650px; overflow:auto">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">社区矫正机构信息明细</h4>
					</div>
					<div class="modal-body">
						<div id="jzjzlxx-form" >
							<input type="text" name="jgbm"	label="机构编码"   disabled/>
							<input type="text" name="jgmc"	label="机构名称"   disabled/>
							<input type="text" name="jgjc"	label="机构简称"   disabled/>
							<input type="text" name="ywmc"	label="英文名称"   disabled/>
							<input type="text" name="jgdm"	label="机构代码"   disabled/>
							<input type="text" name="fzr"	label="负责人"   	disabled/>
							<input type="text" name="jglb"	label="机构类别"   disabled		code="SYS004" id="jglbjy"/>
							<input type="text" name="jgxzjb"	label="机构行政级别" disabled  	code="SYS006" id="jgxzjbjy"/>
							<input type="text" name="jglscj"	label="机构隶属层级" disabled   code="SYS005" id="jglscjiy"/>
							<input type="text" name="sjsfxzzgjg"	label="上级司法行政主管机关"   disabled/>
							<input type="text" name="sjsfxzzgbm"	label="上级司法行政主管部门"   disabled/>
							<input type="text" name="regionid"	label="行政区划ID"   disabled/>
							...
							<input type="text" name="yb"	label="邮编"   disabled/>
							<input type="text" name="dz"	label="地址"   disabled/>
