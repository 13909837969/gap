...
<script type="text/javascript" src="${localCtx}/json/SqjzgzryxxbService.js"></script>
<script type="text/javascript" src="${localCtx}/json/RegionService.js"></script>
<script type="text/javascript">
	$(function() {
		//链接Service
		var Service = new SqjzgzryxxbService();
		//左侧col-md-3内容排版
		...
		$("#lszhglLsxxhq_list #submit").click(function(){
			query["rybm[like]"]= $("#rybm1").val();
			query["xm[like]"] = $("#xm1").val();
			query["ywm[like]"] = $("#ywm1").val();
			query["xb[like]"] = $("#xb1").val();
			query["ssjg[like]"] = $("#ssjg1").val();
			query["zw[like]"] = $("#zw1").val();
			query["zzmm[like]"] = $("#zzmm1").val();
			query["sjhm[like]"] = $("#sjhm1").val();
			query["sfzh[like]"] = $("#sfzh1").val();
			tableView.refresh();
		});
		//重置按钮
	   ...
	   $('#remain_lsxxhq_1').click(function () {
		...
		/* $("#ssjg1").append('$(<option selected></option>)');  code编码尚未加入*/
		//默认隐藏的区域选择
		//区域选择div
	...
	//模态框select下拉选禁用
		...
		$("#zgxwjy").attr("disabled","disabled");
		$("#zyjy").attr("disabled","disabled");
		$("#rybzjy").attr("disabled","disabled");
...
<!-- 左侧查询信息 -->
	...
	<div  class="col-md-3" style="top:30px;height:100%;border: 1px solid #ccc;border-radius: 5px;position:fixed;">
		<div class="col-md-12 " style="text-align:center;">
			<p  class="glyphicon glyphicon-user"  style="font-size:16px;margin-top: 10px;padding-left:20px;">&nbsp;社区矫正工作人员信息查询</p>
			...
			<div class="list-form-style col-md-12" style="padding-top:20px; ">
				<form id="form_lsxxhq" style="margin-bottom:0px; ">
					...
					<!-- <input type="text"  id="ssjg1"	 name="ssjg" 	label="所属机构" 	maxlength="30"  />code 编码尚未加入 -->
						<input type="text"  id="rybm1"	 name="rybm" 	label="人员编码" 	maxlength="30"  />
						<input type="text"  id="xm1"	 name="xm" 		label="姓名" 		maxlength="30"  />
						<input type="text"  id="ywm1"	 name="ywm" 	label="英文名" 	maxlength="30"  />
						<input type="text"  id="xb1"	 name="xb" 		label="性别" 		maxlength="30"  code="sys000" />
						<input type="text"  id="zw1"	 name="zw" 		label="职务" 		maxlength="30"  />
						<input type="text"  id="zzmm1"	 name="zzmm" 	label="政治面貌" 	maxlength="30"  code="sys091"/>
						<input type="text"  id="sjhm1"	 name="sjhm" 	label="手机号码" 	maxlength="30"  />
						<input type="text"  id="sfzh1"	 name="sfzh" 	label="身份证号" 	maxlength="30"  />
				</form>
...
<!-- 表头 -->
			<div class="col-md-12"style="border:1px solid #ccc;border-radius:4px;margin-top: 30px;">
				...
				<div class="row" style="height:40px;padding-top:5px;border-bottom:1px solid #ccc;">
					<div class="col-md-3 glyphicon glyphicon-user" id="sjqk"  style="font-size:18px;color:#333;" ><span style="color:#333;padding-left:10px;">社区矫正工作人员分析</span></div>
			...
			<div class="col-md-12"  id="table_view" style="padding-left:15px; ">		
				<div class="col-md-4" style="height:230px;" >
					<div   class="form-AjlxMs-1 col-md-12">
						<div class="form-AjlxMs" style="font-size:16px;">社区矫正工作人员信息类别情况</div>
						<div class="col-md-12"  style="margin-top:30px;height:30px;">
							<div class="col-md-7">
								<div class="form-AjlxMs" style="font-size:14px;padding-top:0px;line-height:30px;">内蒙古矫正人员</div>
							</div>
							<div class="col-md-5">
						...
						<div class="col-md-12"  style="margin-top:20px;height:30px;">
							<div class="col-md-7">
								<div class="form-AjlxMs" style="font-size:14px;padding-top:0px;line-height:30px;">呼和浩特矫正人员</div>
							</div>
							<div class="col-md-5">
...
<!-- 查询的内容 -->
	<div id="list_lsxxhq" style="margin-top: 10px">
				<div field="rybm" 	name="rybm"  	label="人员编码" ></div>
				<div field="xm"  	name="xm" 		label="姓名" ></div>
				<div field="ywm"  	name="ywm" 		label="英文名" ></div>
				<div field="mz"  	name="mz" 		label="民族"  code="sys003"></div>
				<div field="ssjg"  	name="ssjg" 	label="所属机构" ></div>
				<div field="zw"  	name="zw" 		label="职务" ></div>
				<div field="sfzh"  	name="sfzh" 	label="身份证号" ></div>
				<div field="sjhm"  	name="sjhm" 	label="手机号码" ></div>
				<div field="ckxx" 	name="ckxx" 	label="查看详细"></div>
		</div>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content" style="position:absolute; height:650px; overflow:auto">
					...
					<div class="modal-body">
						<div id="jzjzlxx-form" >
							<input type="text" name="rybm"	label="人员编码"  	disabled/>
							<input type="text" name="xm"	label="姓名"  	disabled/>
							<input type="text" name="ywm"	label="英文名"  	disabled/>
							<input type="text" name="xb"	label="性别"   	code="sys000" id="xbjy"/>
							...
							<input type="text" name="zgxw"	label="最高学位"   code="sys094"  id="zgxwjy"/>
							<input type="text" name="zy"	label="专业"  	code="sys095" 	id="zyjy"/>
							<input type="text" name="ssjg"	label="所属机构"  	disabled />
							<input type="text" name="zw"	label="职务"  	disabled/>
							<input type="text" name="rybz"	label="人员编制(人员类型)"   code="sys007" id="rybzjy"/>
							<input type="text" name="cjgzsj"	label="参加工作时间"  disabled/>
							<input type="text" name="sjhm"	label="手机号码"  disabled/>
