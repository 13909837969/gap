...
<!-- Jquery -->
	...
	<script type="text/javascript" src="js/myEchart/tinformation.js"></script>
	...
	<script type="text/javascript" src="../../../json/BAAARCService.js"></script>
	...
	$(function(){
		...
		tv.loadData(function(page,res){
			rc.find({ "BAAA_RC02[like]" :$("#txtName").val().trim()},page,res);
		});
		//查询按钮事件
			...
			<div class="sidebar-inner scrollable-sidebar">
				...
				<div class="main-menu">
					<ul>
						...
						<li class="active openable open"><a href="tinformation.jsp">
								<span class="menu-icon"> <i class="fa fa-group fa-lg"></i>
			...
			<div class="padding-md">
				<div class="panel panel-default table-responsive">
					<div class="panel-heading">
						<i class="fa fa-group fa-lg"></i> 人才信息查询 <!-- <span
							class="label label-info pull-right">790 项目</span> -->
					</div>
					<!--年龄性别分布图 -->
					<div class="col-md-4 col-sm-4">
						<div id="nlChart" style="height: 200px; width: 100%"></div>
					</div>

					<!--学历排名 -->
					<div class="col-md-4 col-sm-4">
						<div id="txlChart" style="height: 200px; width: 100%"></div>
					</div>
					<!--性别排名 -->
					<div class="col-md-4 col-sm-4">
						<div id="txbpChart" style="height: 200px; width: 100%"></div>
					</div>
					...
					<div id="dg">
						<div field="baaa_rc02" label="姓名"></div>
						<div field="baaa_rc03" label="性别"></div>
						<div field="baaa_rc04" label="出生日期"></div>
						<div field="baaa_rc05" label="民族"></div>
						<div field="baaa_rc06" label="工作单位"></div>
						<div field="baaa_rc07" label="职业"></div>
						<div field="baaa_rc08" label="所学专业"></div>
