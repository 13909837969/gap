...
<script type="text/javascript" src="js/myEchart/disabled.js"></script>
...
<script type="text/javascript" src="../eht.ui.tableview.querycss.js"></script>
	...
	$(function(){
		...
		tv.loadData(function(page,res){
			cj.find({ "BAAA_CJ02[like]" :$("#txtName").val().trim()},page,res);
		});
		//查询按钮事件
			...
			<div class="sidebar-inner scrollable-sidebar">
				...
				<div class="main-menu">
					<ul>
						...
						<li><a href="suballowances.jsp"> <span class="menu-icon">
						...
						<li class="active openable open"><a href="disabled.jsp">
								<span class="menu-icon"> <i class="fa fa-tasks fa-lg"></i>
			...
			<div class="padding-md">
				<div class="panel panel-default table-responsive">
					<div class="panel-heading">
						<i class="fa fa-tasks fa-lg"></i> 残疾人员查询 
						<!-- <span class="label label-info pull-right">790 项目</span> -->
					</div>
					<!--残疾类别 -->
					<div class="col-md-4 col-sm-4">
						<div id="dcjlbChart" style="height: 230px; width: 100%"></div>
					</div>
					<!--残疾人等级 -->
					<div class="col-md-4 col-sm-4">
						<div id="dcjdjChart" style="height: 230px; width: 100%"></div>
					</div>
					<!--婚姻状况 -->
					<div class="col-md-4 col-sm-4">
						<div id="dhyChart" style="height: 230px; width: 100%"></div>
					</div>
					...
					<div id="dg">
						<div field="baaa_cj02" label="姓名"></div>
						<div field="baaa_cj03" label="性别"></div>
						<div field="baaa_cj04" label="出生日期"></div>
						<div field="baaa_cj05" label="身份证号"></div>
						<div field="baaa_cj06" label="婚姻状况"></div>
						<div field="baaa_cj08" label="残疾类别"></div>
						<div field="baaa_cj09" label="等级"></div>
						<div field="baaa_cj10" label="手机号码"></div>
						<div field="baaa_cj07" label="详细地址（住址）"  width="360"  align="left"></div>
