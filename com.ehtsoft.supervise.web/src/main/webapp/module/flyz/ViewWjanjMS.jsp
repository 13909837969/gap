...
<script type="text/javascript">
	$(function() {
		...
		//显示隐藏的区域选择
		$("#ViewWjanjMS_qyss").click(function(){
		...
		/*时间事件*/
		$("#ViewWjanjMS_kssj").unbind("click").bind("click",function(){
	//日历
...
$("#ViewWjanjMS_jssj").unbind("click").bind("click",function(){
	//日历
	$(".form_datetime").datetimepicker({
	       format: "yyyy-mm-dd",
	       language:  'zh-CN',
		...
		/**表1-已结案件总数*/
		var dom = document.getElementById("rofm-Wjanj-zs");
		...
		//表2，已结案件总数环比率
		var dom = document.getElementById("rofm-Wjanj-hb");
		var myChart = echarts.init(dom);
		var app = {};
		option = null;
		option = {
		...
		/*表4-已结案件总数的同比率*/
		var dom = document.getElementById("rofm-Wjanj-tb");
		var myChart = echarts.init(dom);
		var app = {};
		option = null;
...
<!--表头搜索 总计  -->
		<div class="col-md-12"  style="padding-top:20px;">
			<div class="col-md-5" id="test1">
				<div class="col-md-3">
					<input type="text" class="form-control" id="ViewWjanjMS_qyss" placeholder="区域搜索">
				</div>
				<div class="col-md-3">
					<input type="text" class="form-control form_datetime" id="ViewWjanjMS_kssj"placeholder="开始时间">
				</div>
				<div class="col-md-3">
					<input type="text" class="form-control form_datetime" id="ViewWjanjMS_jssj"placeholder="结束时间">
				</div>
				<div class="col-md-3">
			...
			<div class="col-md-7">
				<div  class="col-md-3">
					<div class="col-md-12" id="text3">
						<p style="margin-top: 15px"><a href="#">内蒙古自治区未结案件类型总数</a></p>
						<p>24961件</p>
					</div>
				</div>
				...
				<div  class="col-md-3">
					<div class="col-md-12" id="text3">
						<p style="margin-top: 15px">内蒙古自治区刑事法律援助未结束案件总数</p>
						<p>24961件</p>
					</div>
				</div>
				<div  class="col-md-3">
					<div class="col-md-12" id="text3">
						<p style="margin-top: 15px">内蒙古自治区民事刑政法律援助未结案总数</p>
						<p>24961件</p>
					</div>
				</div>
				<div  class="col-md-3">
					<div class="col-md-12" id="text3">
						<p style="margin-top: 15px">内蒙古自治区民事法律援助未结案总数</p>
						<p>24961件</p>
					</div>
				</div>
			</div>	
		...
		<!-- 1-已结案件总数图表 -->
		<div class="col-md-12" >
			<div class="col-md-12" id="Wjanj-div1">
				<div style="background-color: #333;" class="form-Wjanj-1" >
					<div class="form-Wjanj"><a href="#">内蒙古自治区未结案件总数</a></div>
					<div id="rofm-Wjanj-zs" style="width: 100%; height: 400px; height: 360px"></div>
				</div>
			</div>
		</div>
		<!-- 2-已结案件的环比率 -->
		<div class="col-md-12">
			<div class="col-md-5" id="Wjanj-div2">
				<div style="background-color: #333;" class="form-Wjanj-1" >
				<div class="form-Wjanj">内蒙古自治区未结案件总数的环比率</div>
					<div id="rofm-Wjanj-hb" style="width: 100%; height: 400px; height: 360px"></div>
				</div>
			</div>
			<!-- 4-已结案件总数的同比率 -->
			<div class="col-md-7" id="Wjanj-div2">
				<div style="background-color: #333;" class="form-Wjanj-1" >
					<div class="form-Wjanj">内蒙古自治区未结案件总数的同比率</div>
					<div id="rofm-Wjanj-tb"style="width: 100%; height: 400px; height: 360px"></div>
				</div>
			</div>
