...
<script type="text/javascript">
	$(function() {
		...
		$("#ViewZxfsQX_kssj").unbind("click").bind("click",function(){
			//日历
		...
		$("#ViewZxfsQX_jssj").unbind("click").bind("click",function(){
			//日历
			$(".form_datetime").datetimepicker({
			       format: "yyyy-mm-dd",
			       language:  'zh-CN',
		...
		/**表1-咨询方式总览*/
		var dom = document.getElementById("rofm-ZxfsMsQX-zs");
				...
				series : [
						{
							...
							data : [ 1, 100, 500, 400, 200, 200, 200, 200, 200,220
									],
							itemStyle : {
								normal : {
									color : '#0d9bff'
						...
						},
						{
							name : '2017年',
							type : 'bar',
							data : [ 300, 300, 600, 1000, 700, 100, 200, 800, 100,220
									],
							itemStyle : {
								normal : {
									color : '#f5ce0c'
		...
		//表2，咨询方式环比率
		var dom = document.getElementById("rofm-ZxfsMsQX-hb");
		var myChart = echarts.init(dom);
		var app = {};
		option = null;
		option = {
...
/*表4-咨询方式同比率*/
		var dom = document.getElementById("rofm-ZxfsMsQX-tb");
		var myChart = echarts.init(dom);
		var app = {};
		option = null;
...
<!--表头搜索 总计  -->
		<div class="col-md-12"  style="padding-top:20px;">
			<div class="col-md-5" id="test1" style="margin-top: 20px">
				<div class="col-md-3">
					<input type="text" class="form-control" id="ViewZxfsQX_qyss" placeholder="区域搜索">
				</div>
				<div class="col-md-3">
					<input type="text" class="form_datetime form-control form_datetime" id="ViewZxfsQX_kssj"placeholder="开始时间">
				</div>
				<div class="col-md-3">
					<input type="text" class="form_datetime form-control form_datetime" id="ViewZxfsQX_jssj"placeholder="结束时间">
				</div>
				<div class="col-md-3">
			...
			<div class="col-md-2">
					<div class="col-md-12" id="text3">
						<p style="margin-top:10px;font-size:18px;"><a href="#">呼和浩特市咨询人员总数</a></p>
		...
		<!-- 1-咨询方式类型总览图表 -->
		<div class="col-md-12">
			<div class="col-md-7" id="ZxfsMsQX-div1">
				<div style="background-color: #333;"class="rofm-ZxfsMsQX-1">
					<div class="form-ZxfsMsQX" style="font-size:20px;">呼和浩特市咨询方式总览</div>
					<div id="rofm-ZxfsMsQX-zs"style="width:100%;height:360px;"></div>
				</div>
			</div>
			<!-- 2-咨询方式的环比率 -->
			<div class="col-md-5" id="ZxfsMsQX-div1">
				<div style="background-color:#333;" class="rofm-ZxfsMsQX-1">
					<div class="form-ZxfsMsQX">呼和浩特市咨询方式的环比率</div>
					<div id="rofm-ZxfsMsQX-hb"style="width:100%;height:360px;"></div>
				</div>
			</div>
		</div>
...
<!-- 表3-咨询方式分类 -->		
		<div class="col-md-12" style="width: 100%">
			<div class="col-md-5" id="ZxfsMsQX-div2">
				<div style="background-color: #333;" class="rofm-ZxfsMsQX-1">
				<div class="form-ZxfsMsQX">呼和浩特市咨询方式</div>
					<div id="rofm-ZxfsMsQX-fl"style="width: 100%; height: 400px; height: 360px;"></div>
				</div>
			</div>
<!-- 4-咨询方式的同比率 -->
			<div class="col-md-7" id="ZxfsMsQX-div2">
				<div style="background-color: #333;" class="rofm-ZxfsMsQX-1">
				<div class="form-ZxfsMsQX">呼和浩特市咨询方式的同比率</div>
					<div id="rofm-ZxfsMsQX-tb"style="width: 100%; height: 400px; height:360px;"></div>
				</div>
			</div>
		</div>
		<!--  区域显示隐藏的div  -->
