...
<body
	...
	<div>
		...
		<ul class="nav nav-tabs  style="color:black;font-size:15px">
	          ...
	          <li>
			  	<a href="#formSqjzryxfzx_jbxx" data-toggle="tab" >刑罚信息录入</a>
			  </li>
	          <li>
		...
		<!--导航列表页面  -->
			...
			<div class="tab-pane" id="formSqjzryjbxx_Grjl"  load="${localCtx}/module/sqjz/formSqjzryjbxx_Grjl.jsp?load=load&id=${param.id}"></div>
			<div class="tab-pane" id="formSqjzryjbxx_JtcyjShgx"  load="${localCtx}/module/sqjz/formSqjzryjbxx_JtcyjShgx.jsp?load=load&id=${param.id}"></div>
			<div class="tab-pane" id="formSqjzryxfzx_jbxx" load="${localCtx}/module/sqjz/formSqjzryxfzx_jbxx.jsp?load=load&id=${param.id}"></div>
