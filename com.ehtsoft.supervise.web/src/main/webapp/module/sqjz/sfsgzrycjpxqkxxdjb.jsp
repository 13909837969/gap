...
<html>
<head>
<title>司法所工作人员参加培训情况信息登记表</title>
...
<body>
<div class="ds" >
	<h3 align="center">司法所工作人员参加培训情况信息登记表</h3><br/>
	<div id="sqjz_fromDcpg_add " >
		<div id="sqjz_fromDcpg_add_form">
			...
			<div class="row form-group">
				<label for="lastname" class="col-sm-2 control-label">实际参加学时：</label>
				<div class="col-sm-10 div" >
					<input name="sjcjxs" type="text" class="form-control" id="lastname"
						placeholder="实际参加学时" >
				</div>
			</div>
