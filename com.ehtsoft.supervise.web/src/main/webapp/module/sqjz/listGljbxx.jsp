...
<div class="panel panel-default" id="listGljbxx">
		...
		<div class="panel-body" >
			<div id="gljbxx-form">
				...
				<input type="text" name="bdrq" label="变动日期" placeholder="变动日期" valid="{required:true}" class="form_date" data-date-format="yyyy-MM-dd" readonly="readonly"/>
				<input type="text" name="spr" label="审批人" placeholder="审批人" valid="{required:true}" value="${CURRENT_USER_SESSION.name}" readonly="true"/>
				<input type="text" id="spsj1" name="spsj" label="审批时间" placeholder="审批时间" valid="{required:true}" readonly="readonly" />
				<textarea name="tzyy" placeholder="调整原因" label="调整原因" maxlength="500" id="floor" style="resize: none;"></textarea>
		...
		<div class="panel-body">
			<div id="tableview" class="table-responsive">
				...
				<div field="gljb" label="管理级别" code="sys054"></div>
