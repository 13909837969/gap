...
<script type="text/javascript" src="js/myEchart/unemploypeople.js"></script>
	...
	<script type="text/javascript" src="../../../json/BAAASYService.js"></script>
	...
	$(function(){
		...
		tv.loadData(function(page,res){
			sy.find({ "BAAA_SY02[like]" :$("#txtName").val().trim()},page,res);
		});
		//查询按钮事件
			...
			<div class="padding-md">
				<div class="panel panel-default table-responsive">
					<div class="panel-heading">
						<i class="fa fa-umbrella fa-lg"></i> 失业人员查询
						<!-- <span class="label label-info pull-right">790 项目</span> -->
					</div>
					<!--性别分布 -->
					<div class="col-md-4 col-sm-4">
							<div id="uxbChart" style="height: 200px; width: 100%"></div>
					</div>
					<!--年龄性别分布图 -->
					<div class="col-md-4 col-sm-4">
					
							<div id="unlChart" style="height: 200px; width: 100%"></div>
						
						<!-- /panel -->
					</div>
						<!--是否单身 -->
					<div class="col-md-4 col-sm-4">
							<div id="udsChart" style="height: 200px; width: 100%"></div>
						<!-- /panel -->
					</div>
					...
					<div id="dg">
						<div field="baaa_sy02" label="姓名"></div>
						<div field="baaa_sy03" label="性别"></div>
						<!-- <div field="baaa_sy04" label="民族"></div> -->
						<div field="baaa_sy05" label="身份证号"></div>
						<div field="baaa_sy06" label="是否单身"></div>
						<div field="baaa_sy07" label="失业原因"></div>
						<!-- <div field="baaa_sy08" label="详细地址（住址）"  width="360"></div> -->
