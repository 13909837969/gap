	...
	<input id="hiddencyId" type="hidden" name="id" value="<%=id%>"/>
		...
		<div class="row" id="sqjzjbxx-panel-shgx">
			<div id="sqjzjbxx-shgx" class="grjl-border">
				...
				<input  name="szdw" type="text" label="所在单位（所在地）:" autocomplete="off"  valid="{required:true}" >
				<input  name="jtzz" type="text" label="家庭住址（所在地）:" autocomplete="off"  valid="{required:true}" >
				<input name="lxdh" type="text" label="联系电话:" autocomplete="off"  valid="{required:true}" >
