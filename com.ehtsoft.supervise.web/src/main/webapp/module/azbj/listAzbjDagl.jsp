...
$(function(){	
	...
	//基本人员信息模态框
	var model_jbxx = new Eht.Form({formCol:2,selector:"#model_azbjJbxx",autolayout:true});
	//基本信息与服刑信息模态框
	var modal_all = new Eht.Form({selector:"#modal_all",autolayout:true,});	
	//服刑信息明细操作页面
	var fxxx_model = new Eht.Form({formCol:2,selector:"#model_azbjFxxx",autolayout:true});
	//载入表格
	...
	$('#btn_view').click(function(){
		if (checkSelected()){
			$('#myModal').modal();
			modal_all.fill($("#list_table :checkbox:checked").data());
			model_jbxx.disable();
			fxxx_model.disable();
			$("#btn_save").hide();
		}
	...
	$("#btn_save").click(function(){
		if(fxxx_model.validate()){
			 var data_a = fxxx_model.getData(); 
...
<div id="list_table">
	<div field="xx1" label="选项" width="60" checkbox=true></div>
		...
		<div class="modal-content" >
			<div class="modal-header" >
				...
				<ul class="nav nav-tabs">
					<li class="active">
						<a href="#model_azbjJbxx" data-toggle="tab">人员基本信息</a>
					</li>
					<li>
						<a href="#model_azbjFxxx" data-toggle="tab">服刑人员服刑信息</a>
					</li>
				</ul>
			</div>
			<div class="modal-body" style="overflow: auto; height: 470px;">
				<div class="tab-content" style="height: 100%;">
					<div id="model_azbjJbxx" class="tab-pane active">							
					...
					<div id="model_azbjFxxx" class="tab-pane">
						...
						<textarea rows="8" name="remark" type="text" maxlength="250" label="服刑期间特殊情况备注及帮教建议" ></textarea>
						<textarea rows="8" name="sw_shuoming" type="text" maxlength="250" label="死亡说明" ></textarea>											  
					</div>
				</div>
			</div>
