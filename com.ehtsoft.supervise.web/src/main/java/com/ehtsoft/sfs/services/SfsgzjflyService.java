...
public class SfsgzjflyService extends AbstractService {
	...
	public ResultList<BasicMap<String, Object>> find(BasicMap<String, Object> query,Paginate paginate){
		...
		//String sqlstr = "select * from SFS_SFSGZJFLYXXB";
		String sqlstr="select a.*,b.id as jgid,b.jgbm,b.jgmc from SFS_SFSGZJFLYXXB a inner join JC_SFXZJGJBXX b on a.s_id = b.id";
		...
		ResultList<BasicMap<String, Object>> list = dbClient.find(sql,paginate, new RowDataListener() {
			...
			public void processData(BasicMap<String, Object> rowData) {
				rowData.put("nf", DateUtil.format(rowData.get("nf"), "yyyy-MM-dd"));
	...
	public void deleteOne(String id) {
		String sqlstr="delete from SFS_SFSGZJFLYXXB where id=?";
