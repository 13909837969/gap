 ...
 *
 */
@Service("SfsSbzqkxxcjbService")
public class SfsSbzqkxxcjbService extends AbstractService {
	...
	public void deleteOne(BasicMap<String, Object> query) {
		dbClient.remove(SupConst.Collections.SFS_SFSBZQKXXB, new SqlDbFilter().eq("id", StringUtil.toEmptyString(query.get("id"))));
	}
