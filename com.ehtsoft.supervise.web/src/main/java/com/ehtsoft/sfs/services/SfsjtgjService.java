...
@Service("SfsjtgjService")
public class SfsjtgjService extends AbstractService {
	...
	public ResultList<BasicMap<String, Object>> find(BasicMap<String, Object> query,Paginate paginate){
		...
		//String sqlstr = "select * from SFS_SFSJTGJXXB";
		String sqlstr="select a.*,b.id as jgid,b.jgbm,b.jgmc from SFS_SFSJTGJXXB a inner join JC_SFXZJGJBXX b on a.s_id = b.id";
	...
	public void deleteOne(String id) {
		String sqlstr="delete from SFS_SFSJTGJXXB where id=?";
