...
public class JzTqjxxxService extends AbstractService{
	...
	public ResultList<BasicMap<String, Object>> find(BasicMap<String, Object> data, Paginate paginate) {
		...
		String sql = "select distinct b.id,b.aid,a.sqjzrybh,a.xm,a.xb,a.grlxdh,a.sfzh,a.orgid,a.cuid," + 
	...
	public void save(BasicMap<String, Object> data) {
		...
		if(aid==null){
			throw new AppException("上报提请减刑信息的服刑人员不能为空");
		}
		...
		auditApply.setTitle(fxryxm + "的减刑信息上报");
	...
	//查询审批记录
	public List<AuditHistory> getAuditHistory(String id){
