...
public class SqylService {
	...
	public  BasicMap<String, Object> findSqyl() {
		...
		//警告
		String sql7="select count(1) as jzryjg from JZ_JZRYJBXX a join REP_ALARM b on a.id=b.f_aid where a.sfjs='1' and a.jcjz='0' and b.f_solve = '0' and a.orgid is not null";
     ...
     * @return
     */
    public List<BasicMap<String,Object>> findWcsqDetail(String city_code){
      	 if ("".equals(city_code)) {
			city_code = "150100";//默认返回呼和浩特市
		 }
    	     List<BasicMap<String,Object>> list=new ArrayList<>();
    	     String sql="select count(wc.id) as wcsqs,jc.jgmc,sys.parentid as city_code from jc_sfxzjgjbxx jc inner join " + 
    	     		...
    	     		"on a.region_code=b.regionid ) sys on jc.regionid = sys.regionid  where sys.parentid='"+city_code+"' group by jc.jgmc,sys.parentid";
    	     SQLAdapter adapter=new SQLAdapter(sql);
     ...
     * @return
     */
    public List<BasicMap<String,Object>> findJzdbgDetail(String city_code){
    	     if("".equals(city_code)) {
    	    	     city_code = "150100";
    	     }
    	     List<BasicMap<String,Object>> list=new ArrayList<>();
    	     String sql="select count(wc.id),jc.jgmc,sys.parentid as city_code from jc_sfxzjgjbxx jc inner join " + 
     ...
     * @return
     */
    public List<BasicMap<String,Object>> findZacfDetail(String city_code){
      	if("".equals(city_code)) {
   	         city_code = "150100";
         }
	    List<BasicMap<String,Object>> list=new ArrayList<>();
